    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          {token && (
            <div className=" group-hover:block hidden absolute dropdown-menu ring-0 pt-4 pr-10">
              <div className="flex flex-col gap-2 w-36 py-3 px-5 bg-slate-100 text-gray-500 rounded relative right-14">
      ...
      <div
        className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all duration-500  ease-in-out ${
